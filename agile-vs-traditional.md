...
- **Use Waterfall** when the problem is well-understood, requirements are stable, and failure is catastrophic (think: medical devices, space launches).
- **Use Agile** when the problem is complex, requirements will change, and speed-to-learning matters more than speed-to-plan (think: most software).
